 ...
 * @uses lotwlabs_header_style() to style front end.
...
//Default Images
    $header_images = array(
    	'header1' => array(
            'url'           => get_template_directory_uri() . '/img/headers/header1.png',
            'thumbnail_url' => get_template_directory_uri() . '/img/headers/header1.png',
            'description'   => 'Header 1',
		),
    	'header2' => array(
            'url'           => get_template_directory_uri() . '/img/headers/header2.png',
            'thumbnail_url' => get_template_directory_uri() . '/img/headers/header2.png',
            'description'   => 'Header 2',
		),
    	'header3' => array(
            'url'           => get_template_directory_uri() . '/img/headers/header3.png',
            'thumbnail_url' => get_template_directory_uri() . '/img/headers/header3.png',
